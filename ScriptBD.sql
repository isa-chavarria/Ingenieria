...
DROP TABLE IF EXISTS `kinderbd`.`mensaje` ;

CREATE TABLE IF NOT EXISTS `kinderbd`.`mensaje` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `asunto` VARCHAR(200) NULL DEFAULT NULL,
  `mensaje` VARCHAR(5000) NULL DEFAULT NULL,
  `persona` VARCHAR(50) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `kinderbd`.`mensajeKinder` ;

CREATE TABLE IF NOT EXISTS `kinderbd`.`mensajeKinder` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `asunto` VARCHAR(200) NULL DEFAULT NULL,
  `mensaje` VARCHAR(5000) NULL DEFAULT NULL,
  `persona` VARCHAR(50) NULL DEFAULT NULL,
