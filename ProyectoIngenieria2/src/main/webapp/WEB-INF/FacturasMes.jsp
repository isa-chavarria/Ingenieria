            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-info alert-dismissable">
                        <a href="<c:url value='/FacurasSeleccionar' />" class="btn btn-default custom-width">Observar facturas por estudiante</a>
            ...
            <div class="row">
                ...
                <form:form method="POST" action="seleccionarPagos"  modelAttribute="grupo" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
                    ...
                    <div   class="form-inline">
                        ...
                        <div class="col-lg-4">
                            <form:select path="nivel" items="${Meses}" itemValue="codigo" itemLabel="mes" class="form-control input-sm" id="nivel" required="true" />
    ...
    <script>
        $(document).ready(function () {
            $('#nivel').change(function (event) {
                ...
                // Si en vez de por post lom queremos hacer por get, cambiamos el $.post por $.get
                $.post('seleccionarMes', {
                    nombre: nombreVar
