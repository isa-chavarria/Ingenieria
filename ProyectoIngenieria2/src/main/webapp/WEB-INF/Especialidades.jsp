...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo">Cursos Especiales </h3>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <button style=" font-family: 'Josefin Slab','Helvetica Neue',Helvetica,Arial,sans-serif;" type="button" id="" class="btn btn-info custom-width" data-toggle="modal" data-target="#myModal2">Agregar nuevo curso</button>
                    ...
                    <div style=" overflow: scroll ; height: 300px " class="box">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody class="cuerpoTabla">
                                <c:forEach items="${cursos}" var="nivel">
                                    <tr class="active">
                                        <td>${nivel.nombre}</td>
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form:form method="POST" action="EditarCurso"  modelAttribute="grupo" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
        ...
        <div id="myModal2" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form:form method="POST" action="AgregarCurso"  modelAttribute="grupo" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
                        <form:input type="hidden" path="id"  id="valor"/>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form:form method="POST" action="EliminarCurso"  modelAttribute="clase" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
