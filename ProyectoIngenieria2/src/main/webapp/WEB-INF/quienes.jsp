...
<html lang="en">
    ...
    <body>
        ...
        <div class="row" >
            ...
            <div class="col-sm-8" style="text-align: left; margin-top: 3%;">
                <h1 style="color:#ff3333; margin-left:3%;">¿Quiénes Somos?</h1>
            </div>
        </div>
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container-nav">
                ...
                <div style="margin-left: 13%;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="requerimientos.jsp">Requerimiento de matricula</a>
                        </li>
                        <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <p>Administracion del Kinder Copyright 2015</p>
                    </div>
                </div>
            </div>
        </footer>
