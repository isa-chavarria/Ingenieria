...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo">Bandeja de entrada</h3>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body" style="font-family: 'Josefin Slab','Helvetica Neue',Helvetica,Arial,sans-serif; ">
                            <div class="form-group">                               
                                <a href="mensajes" class="btn btn-success custom-width">Enviar mensaje al kinder</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
            ...
            <div id="myModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form:form method="POST" action="EliminarMensajeKinder"  modelAttribute="mensaje" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
