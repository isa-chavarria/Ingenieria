<%-- 
    Document   : ActualizarNoticia
    Created on : Mar 13, 2016, 6:45:33 PM
    Author     : Isa
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo">MODIFICAR NOTICIA</h3>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="noticiasAdministrador">Regresar al menú</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <h2 class="intro-text text-center">Modificar Noticia
                        </h2>
                    ...
                    <form:form method="POST" action="ModificarNoticiaModicado" modelAttribute="noticia" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
