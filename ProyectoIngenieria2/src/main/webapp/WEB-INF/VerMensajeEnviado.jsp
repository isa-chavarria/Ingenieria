...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo">Mensaje enviado</h3>
                ...
                <div class="col-lg-9 text-center">
                    <div class="panel panel-default">
                        <div class="panel-body" style="font-family: 'Josefin Slab','Helvetica Neue',Helvetica,Arial,sans-serif; ">
                            ...
                            <h4 class="media-heading" style="color: red">Mensaje enviado al kinder </h4>
                            <br/>
                            <br/>
                            ...
                            <c:if test="${!adjunto}">
                                <br/>
                                <br/>
                                <label style="margin:3%;">Archivo adjunto: </label><a href="descargar2-${mensaje.codigo}">${mensaje.name} <i class="fa fa-download" aria-hidden="true"></i></a>
                            </c:if>
                        </div>
                    </div>
                </div>
