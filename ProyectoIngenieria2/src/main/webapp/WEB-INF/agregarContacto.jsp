        ...
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    ...
                    <form:form method="GET" action="/AgregarContactosKinder" modelAttribute="contacto" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
