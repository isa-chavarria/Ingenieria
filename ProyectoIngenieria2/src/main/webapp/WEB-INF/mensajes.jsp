        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <label for="ejemplo_email_3" class="col-lg-2 control-label">Para:</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    ...
                    <div  class="col-lg-10">
                        <textarea name="textfield2"  cols="100" rows="5" wrap="VIRTUAL"></textarea>
                    </div>
                </div>
