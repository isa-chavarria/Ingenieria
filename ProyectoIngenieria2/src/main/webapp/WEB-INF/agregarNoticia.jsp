...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo">AGREGAR NOTICIAS</h3>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <h2 class="intro-text text-center">Agregar Noticia
                        </h2>
                    ...
                    <form:form method="POST" modelAttribute="noticia" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form" action="AgregarNoticias">
