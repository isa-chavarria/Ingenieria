<%-- 
    Document   : ActualizarQuienes
    Created on : Mar 16, 2016, 10:16:37 PM
    Author     : Isa
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="quienesAdministrador">Regresar al menú</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    ...
                    <form:form method="POST" action="ModificarQuienesModicado" modelAttribute="kinder" style='font-family: "Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif;' class="form-horizontal" role="form">
