            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-info alert-dismissable">
                        <a href="<c:url value='/FacurasPorMes' />" class="btn btn-default custom-width">Observar facturas por mes</a>
                            ...
                            <tbody class="cuerpoTabla">
                                <c:forEach items="${grupito.purga()}" var="stu">
                                    <tr class="active">
                                        ...
                                        <td>${stu.apellido1}</td>
                                        <td>${stu.apellido2}</td>
                                        <td><a href="<c:url value='/facturasAdministracion-${stu.id}' />" class="btn btn-success custom-width">Ver Facturas</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
