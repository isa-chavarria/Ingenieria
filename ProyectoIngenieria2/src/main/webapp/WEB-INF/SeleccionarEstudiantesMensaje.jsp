...
<html lang="en">
    ...
    <body>
        ...
        <div id="second"  class="row">
            ...
            <h3 id="Titulo"> Enviar mensaje estudiantes </h3>
                            ...
                            <tbody class="cuerpoTabla">
                                <c:forEach items="${grupito.purga()}" var="stu">
                                    <tr class="active">
                                        ...
                                        <td>${stu.apellido1}</td>
                                        <td>${stu.apellido2}</td>
                                        <td><a href="<c:url value='/mensajesKinder-${stu.id}' />" class="btn btn-success custom-width">Enviar mensaje</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
