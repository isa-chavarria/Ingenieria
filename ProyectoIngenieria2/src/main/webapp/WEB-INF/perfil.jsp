    ...
    <body>
        <div   id="arriba" class="row">
            ...
            <div  class="col-sm-8" style=" padding: 1%">
                ...
                <div class="brand">Perfil personal</div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="Encargado.jsp">Regresar al menú</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="leftImage">
                        ...
                        <img class="img-circle" src="img/daryl.jpg" width="50%" height="160px"alt="">
                    </div>
                    ...
                    <button type="submit" style='float: right; margin-top: 5%; margin-right: 20%;' class="btn btn-default">Editar Perfil</button>
                    <div class="dec">  </div>
