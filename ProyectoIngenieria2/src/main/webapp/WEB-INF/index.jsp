    ...
    <body>
        <div   id="arriba" class="row">
            ...
            <div class="col-sm-8" style=" padding: 1%">
                ...
                <form style="margin-top: 3%" class="form-inline" role="form">
                    <div style=" margin-right: 1% " class="form-group">
                        <input  style=" box-shadow: 0px 0px 20px   rgba(0,0,0,0.2)" type="text" class="form-control" placeholder="USUARIO"/>
